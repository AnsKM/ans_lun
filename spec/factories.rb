...
FactoryGirl.define do
  factory :travel_detail do
    travel_round_date "2021-06-17 07:21:54"
    travel_type 1
    from_address "MyString"
    to_address "MyString"
    from_address_latitude "MyString"
    from_address_longitude "MyString"
    to_address_latitude "MyString"
    to_address_longitude "MyString"
    person_id "MyString"
  end
  sequence :id do |_|
