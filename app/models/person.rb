...
#  verification_document_file_name    :string(255)
#  verification_document_content_type :string(255)
#  verification_document_file_size    :integer
#  verification_document_updated_at   :datetime
#
# Indexes
#
...
class Person < ApplicationRecord
  ...
  has_attached_file :verification_document, :styles => {
                      :medium => "288x288#",
                      :small => "108x108#",
                      :thumb => "48x48#",
                      :original => "600x800>"}

  #validates_attachment_presence :verification_document
  validates_attachment_size :verification_document, :less_than => 9.megabytes
  validates_attachment_content_type :verification_document,
                                    :content_type => IMAGE_CONTENT_TYPE << "application/pdf"
