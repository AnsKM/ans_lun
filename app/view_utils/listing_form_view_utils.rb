module ListingFormViewUtils
  ...
  def add_location_params(listing_params, params)
    if params[:origin_loc_attributes].nil? && params[:from_check_address_attributes].nil?
      listing_params
    elsif params[:origin_loc_attributes].nil?
    ...
    elsif params[:from_check_address_attributes].nil?
      params = ActionController::Parameters.new(params)
      location_params = permit_location_params(params).merge(location_type: :from_check_address)

      listing_params.merge(
        from_check_address_attributes: location_params
      )
    else
      params = ActionController::Parameters.new(params)
      location_params = permit_location_params(params).merge(location_type: :origin_loc)
  ...
  def permit_location_params(params)
    p = if params[:location].present?
        ...
        elsif params[:from_check_address_attributes].present?
          params.require(:from_check_address_attributes)
        ...
        elsif params[:listing].present? && params[:listing][:from_check_address_attributes].present?
          params.require(:listing).require(:from_check_address_attributes)
        end
