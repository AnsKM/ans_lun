...
CREATE TABLE `community_memberships` (
  ...
  KEY `tmp_cm_1` (`community_id`,`status`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `listings` (
  ...
  `from_address_latitude` varchar(255) DEFAULT NULL,
  `from_address_longitude` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `locations` (
  ...
  `community_id` int DEFAULT NULL,
  `listing_location_type` int DEFAULT '0',
  PRIMARY KEY (`id`),
...
CREATE TABLE `people` (
  ...
  `verification_document_file_name` varchar(255) DEFAULT NULL,
  `verification_document_content_type` varchar(255) DEFAULT NULL,
  `verification_document_file_size` int DEFAULT NULL,
  `verification_document_updated_at` datetime DEFAULT NULL,
...
CREATE TABLE `travel_details` (
  `id` bigint NOT NULL AUTO_INCREMENT,
  `travel_round_date` varchar(255) DEFAULT NULL,
  `travel_type` int DEFAULT NULL,
  `from_address` varchar(255) DEFAULT NULL,
  `to_address` varchar(255) DEFAULT NULL,
  `from_address_latitude` varchar(255) DEFAULT NULL,
  `from_address_longitude` varchar(255) DEFAULT NULL,
  `to_address_latitude` varchar(255) DEFAULT NULL,
  `to_address_longitude` varchar(255) DEFAULT NULL,
  `person_id` varchar(255) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  PRIMARY KEY (`id`)
